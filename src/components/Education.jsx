      ...
      <div ref={ref} className="w-[75%] mx-auto relative ">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          ...
          <Details
            ...
            info={'Bootcamp Argentino, HTML, CSS, JS, React, Express, Redux, Node, PostgreSQL, Sequelize, Git, GitHub, SCRUM'} />
          <Details
          ...
          <Details
            ...
            info={'Fundamentos de Programación Orientada a Objetos con JavaScript'} />
          <Details
          ...
          <Details
            ...
            time={"2022-2022"}
            place={"Platzi - En línea "}
            info={'Creación de rutas en Angular y programación modular con Lazy Loading.'} />
          <Details
          ...
          <Details
            ...
            time={"2022-2022"}
            place={"Platzi - En línea "}
            info={'Creación de API REST con Express.js, microservicios, bdd y más'} />
          ...
          <Details
            ...
            time={"2022-2022"}
            place={"Platzi - En línea "}
            info={'Base de datos con PostgreSQL en Node.js, migraciones, docker y mucho más.'} />
          <Details
